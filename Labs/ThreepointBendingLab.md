...
2. Spagetti
3. Phone
4. Others: vernier caliper, regular ruler, and marker pen
...
(d) Start test until the spagetti fails.
 ...
 * Choose 5 data points from the curve, whose displacement is $3,4,5,6,7,8 ~\rm mm$, respectively. Then calculate and plot the Young's modulus from each data point (Young's modulus vs. displacement). Is the Young's modulus constant? Add a horizontal line to fit the data.
