...
Instead of making four pieces say we had made 5 pieces, then we would instead got
...
Now let us consider $n+1$ pieces, and then take the limit of $n$ going to infinity. 
$$
\begin{align}
