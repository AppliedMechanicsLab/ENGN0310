...
Say the left face is not allowed to move during the defomation than that would imply that the constant in the above equation is naught. In summary we get the displacement field to be, 
